...
if(isset($_POST['update'])) {
    ...
    $sql = "UPDATE employeedetails SET fName = '$firstname', lName = '$lastname', bio = '$bio', address = '$address', email = '$email', phone = '$phone',  username = '$username', password = '$password', code = '$code' WHERE no = '$id'";
...
if(isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM employeedetails WHERE no = '$id'";
